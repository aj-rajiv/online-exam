...
<body>
    ...
    <div align="center" style="background-color:Yellow">
        <asp:Button ID="Button1" runat="server" Text="VIEW USER DETAILS" 
        ...
        <br />
        <asp:Button ID="Button2" runat="server" Text="VIEW APTI RESULTS" 
        ...
        <br />
        <asp:Button ID="Button3" runat="server" Text="VIEW TECH RESULTS" 
...
&nbsp;<br />
        <asp:Button ID="Button4" runat="server" 
            Text="VIEW INDIVIDUAL CANDIDATE DETAILS" Font-Bold="True" 
        ...
        <br />
        <asp:Button ID="Button5" runat="server" Text="VIEW APTI RESULTS BY NAME" 
        ...
        <br />
        <asp:Button ID="Button6" runat="server" Text="VIEW TECH RESULTS BY NAME" 
    ...
    <br />
        <asp:Button ID="Button7" runat="server" Text="VIEW CORRECT ANSWERS" 
        ...
        <asp:Button ID="Button8" runat="server" Font-Bold="True" 
            Text="VIEW ANSWERS BY QUESTIONS" onclick="Button8_Click" />
        <br />
